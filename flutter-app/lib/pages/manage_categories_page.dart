...
class _ManageCategoriesPageState extends State<ManageCategoriesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var categories = categoryProvider.getCategories(enabledOnly: false);
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(leading: const BackButton(), title: const Text('Manage categories')),
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          ...
                          bool isDuplicate = categoryProvider.existsCategoryWithName(value);
                          if (isDuplicate) {
                  ...
                  return SelectionArea(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          domain.name.isNotEmpty ? domain.name : 'Categories with no domain',
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index2) {
                            ...
                            return Card(
                              child: ListTile(
                                title: Text(category.name, style: TextStyle(color: color)),
                                trailing: IconButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
